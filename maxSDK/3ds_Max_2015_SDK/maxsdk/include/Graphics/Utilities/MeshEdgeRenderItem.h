	...
	*/
	...
	public:
		...
		*/
		...
		DefaultRenderItemAPI ~MeshEdgeRenderItem();
		/** Return whether the item is dirty.
			Setting any parameters or mesh's MESH_CACHEINVALID flag will cause the item dirty.
		\return true if the item is dirty. False if not.
		*/
		DefaultRenderItemAPI bool DirtyFlag();
		/** Clear the dirty flag of the item
		*/
		...
		*/
		...
		\param drawContext
		*/
		DefaultRenderItemAPI virtual void HitTest(HitTestContext& , DrawContext& drawContext);
	...
	*/
	...
	public:
		...
		*/
		...
		\param darwContext draw context of the incoming item
		*/
