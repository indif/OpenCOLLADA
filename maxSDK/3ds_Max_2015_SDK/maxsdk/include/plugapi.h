...
#define MAX_RELEASE					MAX_RELEASE_R17_ALPHA 
...
#define MAX_API_NUM					MAX_API_NUM_R170_PREVIEW 

// 3ds Max 2015 Preview 7 SDK, incompatible with Preview 6 and 3ds Max 2014 SDK
// This is used only for preview builds
#define MAX_SDK_REV_R170_PREVIEW	7
    ...
    not been changed.*/
// Need to set this back to 0 before we ship R17
#define MAX_SDK_REV				MAX_SDK_REV_R170_PREVIEW 
...
#define USERDATATYPE_CLASS_ID		0x000B60    //!< User Datatype class ID.
...
//@{
#define	CTRL_SHORT_CLASS_ID 	   	0x9001  //!< Short controller super-class ID.
#define	CTRL_INTEGER_CLASS_ID		0x9002  //!< Integer controller super-class ID.
#define	CTRL_FLOAT_CLASS_ID			0x9003  //!< Float controller super-class ID.
#define	CTRL_POINT2_CLASS_ID	   	0x9004  //!< Point2 controller super-class ID.
...
#define	CTRL_COLOR_CLASS_ID     	0x9009	//!< Color controller super-class ID.
#define	CTRL_COLOR24_CLASS_ID   	0x900A  //!< Color24 controller super-class ID.
...
#define CTRL_USERTYPE_CLASS_ID		0x900F  //!< User defined type for a controller super-class ID.
