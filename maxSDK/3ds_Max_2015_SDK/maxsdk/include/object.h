...
public:
	...
	// IObjectDisplay entries which would be removed when we finish porting all
	// internal plugins
	...
	* methods will be NULL. */
	...
	details.
	\param mapChannel See <a href="idx__r_list_of_mapping_channel_index_values_html.html">List of
	...
	<a href="idx__r_list_of_mapping_channel_index_values_html.html">List of Mapping
...
public:
	...
	CoreExport virtual unsigned long GetObjectDisplayRequirement() const ;
	CoreExport virtual bool PrepareDisplay(const MaxSDK::Graphics::MaxContext& maxContext, 
	const MaxSDK::Graphics::UpdateDisplayContext& prepareDisplayContext);
	CoreExport virtual bool UpdatePerNodeItems(const MaxSDK::Graphics::MaxContext& maxContext, 
	const MaxSDK::Graphics::UpdateDisplayContext& updateDisplayContext,
	MaxSDK::Graphics::UpdateNodeContext& nodeContext,
	MaxSDK::Graphics::IRenderItemContainer& targetRenderItemContainer);
	...
	*/
	...
	<a href="idx__r_list_of_ptypes_for_shape_html.html">List of Parameter Types for
