...
#pragma region Per-Vertex Data
	...
	<a href="idx__r_list_of_vertex_data_index_options_html.html">List of Vertex Data
	Index Options</a>. */
...
\endcode  */
	...
	/** Performs a Quad Chamfer operation on the flagged edges.
	\par Parameters:
	float amount\n\n
	Indicates how much distance to chamfer\n\n
	int segments\n\n
	Indicates how many segments to create on the chamfered edges (>0 for quads)\n\n
	float tension\n\n
	Indicates how much tension to apply to chamfer (0.0 - 1.0)\n\n
	MN_QCHAM_TYPE resultType\n\n
	Indicates what result is desired. QCHAM_CHAMFEREDOBJECT=chamfered object, QCHAM_NOCHAMFERS=object with chamfered edges removed,
		QCHAM_CHAMFERSONLY=object with chamfered edges only\n\n
	DWORD flag=MN_SEL\n\n
	Indicates which vertices to chamfer.\n\n
	\return  True if any edges were chamfered, false otherwise. */
