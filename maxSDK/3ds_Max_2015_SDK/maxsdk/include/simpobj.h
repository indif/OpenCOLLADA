...
class SimpleObject : public GeomObject
{
	public:
		...
		CoreExport bool PrepareDisplay(const MaxSDK::Graphics::MaxContext& maxContext, 
			const MaxSDK::Graphics::UpdateDisplayContext& prepareDisplayContext);

		CoreExport bool UpdatePerNodeItems(const MaxSDK::Graphics::MaxContext& maxContext, 
...
public:
		...
		See <a href="idx__r_list_of_marker_types_html.html">Marker Types</a>.
		\par Default Implementation:
