...
/*! \sa  <a href="idx__r_list_of_snap_flags_html.html">List of Snap Flags</a>,
...
class ViewExp : public InterfaceServer {
	public:
		...
		*/
		...
		construction plane).
		\param flags See <a href="idx__r_list_of_snap_flags_html.html">List of Snap Flags</a>.
...
From /MAXSDK/SAMPLES/OBJECTS/CYL.CPP in CylinderObjCreateCallBack::proc	 */
		...
		*/
		...
		<a href="idx__r_list_of_mouse_callback_flags_html.html">List of Mouse
		Callback Flags</a>.
...
class CreateMouseCallBack: public MaxHeapOperators {
	public:
		...
		<a href="idx__r_list_of_mouse_callback_messages_html.html">List of Mouse
		Callback Messages</a>.\n\n
		<b>int point</b>\n\n
...
class ViewportDisplayCallback: public InterfaceServer {
	public:
		...
		\param TimeValue t - The current time when this method is called.
		\param ViewExp* vpt - An interface into the viewport.
		\param int flags - These flags are used internally. */
		...
		\param TimeValue t - The time to get the viewport rectangle.
		\param ViewExp* vpt - Specifies which viewport
		\param Rect *rect - The rectangle is returned here. */
...
//except they are used to register display selection call backs
	...
	// watje Gets/Sets the selection filter
		...
		*/
		...
		The parent window handle.\n\n
		<b>DWORD flags</b>\n\n
		See <a href="idx__r_list_of_material_browser_flags_html.html">List of
...
public:
	...
	* \param[in] view ID the unique ID of a viewport. 
	...
	* // Check the ID agaist your stored ID to make sure you get the correct ViewExp interface
	...
	*/
	...
	/**
	* Sets the viewport ID used, when the rendering is locked on a viewport
	...
	* }
	* \endcode
	* \param[in] anim The Animatable to aquire the AppDataChunk from.
